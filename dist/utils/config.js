...
const movieConfig = (obj) => {
    obj = Object.assign(Object.assign({}, obj), { nguoi_dang: (0, exports.userConfig)(obj.nguoi_dung), hinh_anh: variables_1.movieImgResponse + obj.hinh_anh });
...
const cinemaSystemConfig = (obj) => {
    obj = Object.assign(Object.assign({}, obj), { logo: variables_1.systemImgResponse + obj.logo });
    return obj;
};
