...
let CinemasModule = CinemasModule_1 = class CinemasModule {
};
CinemasModule = CinemasModule_1 = __decorate([
    (0, common_1.Module)({
        imports: [CinemasModule_1, prisma_module_1.PrismaModule],
        controllers: [cinemas_controller_1.CinemasController],
        providers: [cinemas_service_1.CinemasProvider, global_dto_1.Response],
    })
], CinemasModule);
